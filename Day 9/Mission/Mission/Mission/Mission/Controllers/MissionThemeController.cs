...
namespace Mission.Controllers
{
    ...
    public class MissionThemeController(IMissionThemeService missionThemeService) : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllMissionTheme()//get all mission
        {
            try
            {
        ...
        public async Task<IActionResult> AddMissionTheme(MissionThemeViewModel missionThemeViewModel)//add mission
        {
            try
            {
        ...
        public async Task<IActionResult> GetMissionThemeById(int id)//get a mission
        {
        ...
        public async Task<IActionResult> UpdateMissionTheme(MissionThemeViewModel missionThemeViewModel)//update mission
        {
        ...
        [HttpDelete]
        [Route("DeleteMissionTheme{id:int}")]//delete mission
